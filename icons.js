/* ==========================================================================
   icons.js — Offline SVG ikon seti (Lucide tabanlı, MIT).
   Tüm ikonlar inline SVG; dış bağımlılık YOK. currentColor ile renk alır.
   Kullanım: icon('play')  ->  buton/etiket içine HTML olarak gömülür.
...
const ICON_PATHS = {
  ...
  eyeOff:      '<path d="M10.73 5.08A10.4 10.4 0 0 1 12 5c7 0 10 7 10 7a13.2 13.2 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.5 13.5 0 0 0 2 12s3 7 10 7a9.7 9.7 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/>',
...
/* icon(name, opts?) -> inline SVG string.
   opts: { size:'1em', cls:'', stroke:2, fill:false } */
function icon(name, opts) {
  ...
  return `<svg class="ic${cls}" xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="${fill}" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${body}</svg>`;
}
